...
// that is visible on the page
    ...
    function _addMarkerToMap(leafletItem, map){
        ...
        if (m.icon === undefined || m.icon.iconUrl === undefined) {
            ...
            var hash = {iconUrl: m.icon.iconUrl};
            if (m.icon.iconRetinaUrl) {hash.iconRetinaUrl = m.icon.iconRetinaUrl}
            if (m.icon.iconSize) {hash.iconSize = m.icon.iconSize}
            if (m.icon.iconAnchor) {hash.iconAnchor = m.icon.iconAnchor}
            if (m.icon.popupAnchor) {hash.popupAnchor = m.icon.popupAnchor}
            if (m.icon.shadowUrl) {hash.shadowUrl = m.icon.shadowUrl}
            if (m.icon.shadowRetinaUrl) {hash.shadowRetinaUrl = m.icon.shadowRetinaUrl}
            if (m.icon.shadowSize) {hash.shadowSize = m.icon.shadowSize}
            if (m.icon.shadowAnchor) {hash.shadowAnchor = m.icon.shadowAnchor}
            var customIcon = L.icon(hash);
